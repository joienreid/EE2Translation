...
EpicerEnemies = {
    ...
    CATHE_Effect_PaucityOnBHWither = {
        ...
        Description = "<font color='A8A8A8' size='17' face='Averia Serif'>I suck power from thee!</font><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='ebc808'>Paucity</font> при 7 B/H, базовые атаки под <font color='ebc808'>Paucity</font> накладывают <font color='ebc808'>Wither</font>.",
    },
